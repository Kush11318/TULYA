  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-between border-b border-slate-200 px-6 py-4 text-left transition-colors hover:bg-slate-50/60"
      >
