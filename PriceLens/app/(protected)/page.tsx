...
export default function Home() {
  ...
  return (
    <main className="page-fade-in relative min-h-[calc(100vh-56px)] bg-slate-50 px-4 py-12">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 md:flex-row md:items-start">
        ...
        <SearchBar onSearch={handleSearch} />
          ...
          <div className="mt-2 rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm">
            <h2 className="text-xs font-semibold uppercase tracking-[0.18em] text-sky-600">
              Recent searches
            </h2>
            <div className="mt-3">
        <History />
        ...
        <section className="mt-8 w-full max-w-md space-y-4 md:mt-0 md:pl-8">
          <div className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
            <h2 className="text-sm font-semibold text-slate-900">Why teams use PriceLens</h2>
